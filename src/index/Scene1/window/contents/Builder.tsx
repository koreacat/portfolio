    ...
    <div className="max-w-4xl mx-auto py-8">
      <div className="flex flex-col items-center space-y-8">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-2">채용 사이트 빌더</h2>
          <br />
        ...
        <div className="max-w-xl mx-auto">
          <div>
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">채용사이트 빌더 개발</h3>
              <p className="text-sm">
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">정규화를 통한 전역 상태 최적화</h3>
              <p className="text-sm">
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">채용사이트 뷰 모듈 개발</h3>
              <p className="text-sm">
