    ...
    <div className="max-w-4xl mx-auto py-8">
      <div className="flex flex-col items-center space-y-8">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold mb-2">구직자 채용 플랫폼 JOBDA</h2>
          <br />
        ...
        <div className="max-w-xl mx-auto">
          <div>
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">프론트엔드 리드</h3>
              <p className="text-sm">
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">잡다 로그인 개발</h3>
              <p className="text-sm">
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">잡다 채팅 서비스 개발</h3>
              <p className="text-sm">
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">잡다 콘텐츠 개발</h3>
              <p className="text-sm">
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">SEO 최적화 작업</h3>
              <p className="text-sm">
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">아키텍쳐 개선 작업</h3>
              <p className="text-sm">
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">디자인 시스템 개발</h3>
              <p className="text-sm">
            ...
            <div className="mb-4">
              <h3 className="text-lg font-semibold">최적화 작업</h3>
              <p className="text-sm">
