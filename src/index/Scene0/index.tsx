...
export default function Scene0({ isTransitionEnd }: Scene0Props) {
  ...
  return (
    <div className="flex flex-col gap-2 items-center justify-center size-full md:gap-8 select-none">
      ...
      <div className="flex flex-wrap items-center flex-col gap-1 mt-3">
        <TransitionContent className="text-my-bg-color group w-fit text-sm md:text-base" type={getTransitionType()} fadeInDelay={getDelay(3)}>
          프론트엔드 개발자 지경민입니다.
        </TransitionContent>
